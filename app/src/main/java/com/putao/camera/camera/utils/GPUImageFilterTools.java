...
import com.putao.camera.camera.gpuimage.GPUImage3x3ConvolutionFilter;
import com.putao.camera.camera.gpuimage.GPUImage3x3TextureSamplingFilter;
import com.putao.camera.camera.gpuimage.GPUImageAddBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageAlphaBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageBrightnessFilter;
import com.putao.camera.camera.gpuimage.GPUImageChromaKeyBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageColorBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageColorBurnBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageColorDodgeBlendFilter;
...
import com.putao.camera.camera.gpuimage.GPUImageDarkenBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageDifferenceBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageDirectionalSobelEdgeDetectionFilter;
import com.putao.camera.camera.gpuimage.GPUImageDissolveBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageDivideBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageEmbossFilter;
import com.putao.camera.camera.gpuimage.GPUImageExclusionBlendFilter;
...
import com.putao.camera.camera.gpuimage.GPUImageGammaFilter;
import com.putao.camera.camera.gpuimage.GPUImageGrayscaleFilter;
import com.putao.camera.camera.gpuimage.GPUImageHardLightBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageHighlightShadowFilter;
import com.putao.camera.camera.gpuimage.GPUImageHueBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageHueFilter;
import com.putao.camera.camera.gpuimage.GPUImageLightenBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageLinearBurnBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageLookupFilter;
import com.putao.camera.camera.gpuimage.GPUImageLuminosityBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageMonochromeFilter;
import com.putao.camera.camera.gpuimage.GPUImageMultiplyBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageNormalBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageOpacityFilter;
import com.putao.camera.camera.gpuimage.GPUImageOverlayBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImagePixelationFilter;
import com.putao.camera.camera.gpuimage.GPUImagePosterizeFilter;
import com.putao.camera.camera.gpuimage.GPUImageRGBFilter;
import com.putao.camera.camera.gpuimage.GPUImageSaturationBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageSaturationFilter;
import com.putao.camera.camera.gpuimage.GPUImageScreenBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageSepiaFilter;
import com.putao.camera.camera.gpuimage.GPUImageSharpenFilter;
import com.putao.camera.camera.gpuimage.GPUImageSobelEdgeDetection;
import com.putao.camera.camera.gpuimage.GPUImageSoftLightBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageSourceOverBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageSubtractBlendFilter;
import com.putao.camera.camera.gpuimage.GPUImageToneCurveFilter;
import com.putao.camera.camera.gpuimage.GPUImageTwoInputFilter;

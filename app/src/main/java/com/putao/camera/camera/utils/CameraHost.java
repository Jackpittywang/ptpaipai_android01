...
public interface CameraHost extends Camera.AutoFocusCallback {
     ...
     *
     * @param parameters the Camera.Parameters to be modified
     ...
     * @return
     */
    Camera.Parameters getExposureCompensation(Camera.Parameters parameters);
     ...
     * audio here.
     *
     * @param cameraId the camera that will be used for recording
     * @param recorder the MediaRecorder to be configured
     */
     ...
     *
     * @param parameters the current camera parameters
     ...
     * @param width              width of the available preview space
     * @param height             height of the available preview space
     * @param parameters         the current camera parameters
     ...
     * @param height             height of the available preview space
     * @param parameters         the current camera parameters
     * @param deviceHint         the size that the device itself thinks should
     ...
     *
     * @param e an Exception indicating what went wrong
     */
     ...
     * called on a background thread.
     *
     * @param image byte array of the picture data (e.g., JPEG)
     */
     ...
     *
     * @param reason a FailureReason indicating what went wrong
     */

...
public class SimpleCameraHost implements CameraHost {
    ...
    public Camera.Size getPictureSize(PictureTransaction xact, Camera.Parameters parameters) {
        return (CameraUtils.getBestPictureSize(parameters));
    }
    ...
    private void initPhotoDirectory() {
        photoDirectory = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), PuTaoConstants.PAIAPI_PHOTOS_FOLDER);

package com.putao.camera.welcome.view;
...
import com.putao.widget.viewpagerindicator.PageIndicator;
...
public class AutoScrollViewPagerCirclePageIndicator extends View implements PageIndicator {
    ...
    public AutoScrollViewPagerCirclePageIndicator(Context context) {
        this(context, null);
    }

    public AutoScrollViewPagerCirclePageIndicator(Context context, AttributeSet attrs) {
...
//        if(count>0&&position == count-1&&mPageOffset==0){
//            Bundle bundle = new Bundle();
//            bundle.putSerializable("iconRes", 111);
//            EventBus.getEventBus().post(
//                    new BasePostEvent(PuTaoConstants.WELCOME_FINISH_EVENT, bundle));
//        }

//Loger.d("chen:onPageScrolled,position="+position+",positionOffset="+positionOffset);

...
public class CollageManagementAdapter extends BaseAdapter {
    ...
    private ArrayList<CollageListInfo.PackageInfo> mDatas;
    ...
    public void setDatas(ArrayList<CollageListInfo.PackageInfo> datas) {
        mDatas = datas;
    }
    ...
    @Override
    public CollageListInfo.PackageInfo getItem(int position) {
        if (mDatas == null) {
            return null;
        }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final CollageListInfo.PackageInfo info = getItem(position);
        Map<String, String> map = new HashMap<String, String>();
        map.put("id", String.valueOf(info.collage_id));
        ...
        ImageLoader.getInstance().displayImage(info.sample_image, holder.collage_download_iv, options);
        return convertView;
    }

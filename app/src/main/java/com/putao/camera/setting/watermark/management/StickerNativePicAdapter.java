...
public class StickerNativePicAdapter extends BasicAdapter<WaterMarkIconInfo, StickerNativePicAdapter.StickerPicHolder> {


    public StickerNativePicAdapter(Context context, List<WaterMarkIconInfo> pics) {
        super(context, pics);
    }
    ...
    @Override
    public void onBindItem(StickerPicHolder holder, WaterMarkIconInfo waterMarkIconInfo, int position) {
//        holder.iv_user_icon.setImageURL(stickerUnZipInfo.imgName);
        String path = WaterMarkHelper.getWaterMarkFilePath() + waterMarkIconInfo.sample_image;

...
package com.putao.widget.pulltorefresh;
...
import com.putao.widget.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.putao.widget.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements OnScrollListener {
    ...
    public void setEmptyIcon(int paramInt) {
        if ((this.mEmptyView != null) && (paramInt > 0)) {
            this.empty_iv.setImageResource(paramInt);
        }
    }

    public void setEmptyText(int paramInt) {
        if ((this.mEmptyView != null) && (paramInt > 0)) {
            this.mEmptyText.setText(paramInt);
        }
    }

    public void setEmptyText(String paramString) {
        if ((this.mEmptyView != null) && (paramString != null)) {
            this.mEmptyText.setText(paramString);
        }
    }
    ...
    public void hideEmptyText() {
        if (mEmptyText != null) {
            this.mEmptyText.setVisibility(View.GONE);
        }
    }
    ...
    public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount, final int totalItemCount) {
        ...
        if (paramOnPositionShowListener != null) {
            final int paramInt = firstVisibleItem + visibleItemCount - 1;
            paramOnPositionShowListener.onPositonShow(paramInt);
        }
    }
    ...
    public void setAdapter(ListAdapter adapter) {
        if (((AdapterView<ListAdapter>) mRefreshableView).getAdapter() != null) {
            ((AdapterView<ListAdapter>) mRefreshableView).getAdapter().unregisterDataSetObserver(mDataObserver);
        }
     ...
     */
    public final void setDefEmptyView() {
        if (mEmptyView == null) {
            View mEmptyView = inflate(getContext(), R.layout.empty_ly, null);
            this.mEmptyText = ((TextView) mEmptyView.findViewById(R.id.empty_text));
            this.empty_iv = ((ImageView) mEmptyView.findViewById(R.id.empty_iv));
            setEmptyView(mEmptyView);
        }
    }

    public final void seEmptyView(int imageId, int tvId) {
        if (mEmptyView == null) {
            View mEmptyView = inflate(getContext(), R.layout.empty_ly, null);
            this.mEmptyText = ((TextView) mEmptyView.findViewById(R.id.empty_text));
            this.empty_iv = ((ImageView) mEmptyView.findViewById(R.id.empty_iv));
            setEmptyView(mEmptyView);
            setEmptyIcon(imageId);
            setEmptyText(tvId);
        }
    }

    public final void seEmptyView(int tvId) {
        if (mEmptyView == null) {
            View mEmptyView = inflate(getContext(), R.layout.empty_ly, null);
            this.mEmptyText = ((TextView) mEmptyView.findViewById(R.id.empty_text));
            this.empty_iv = ((ImageView) mEmptyView.findViewById(R.id.empty_iv));
    ...
    private void addIndicatorViews() {
        ...
        if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
            ...
            params.rightMargin = getResources().getDimensionPixelSize(R.dimen.dimens_10dp);
    ...
    protected OnPositionShowListener paramOnPositionShowListener;

    public static abstract interface OnPositionShowListener {
        public abstract void onPositonShow(int paramInt);
    }

    public void setPositionShowListener(OnPositionShowListener paramOnPositionShowListener) {
        this.paramOnPositionShowListener = paramOnPositionShowListener;
    }
}
